...
#
# nixpkgs comes from this repo's own pins.lock.json, resolved by this repo's own
# vendored resolver -- so the dev environment is an integration test of pnix, and
# the flake has no inputs at all.
{
